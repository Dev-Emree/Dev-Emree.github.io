...
const verdeLink = document.getElementById('verde-link');
if (verdeLink) verdeLink.setAttribute('aria-label', `Verde App - ${translations[e].project_1_desc} - ${translations[e].project_1_role}${translations[e].opens_new_tab}`);

const kitapLink = document.getElementById('kitap-link');
if (kitapLink) kitapLink.setAttribute('aria-label', `Kitap Koçum - ${translations[e].project_2_desc} - ${translations[e].project_2_role}${translations[e].opens_new_tab}`);

const destekalLink = document.getElementById('destekal-link');
if (destekalLink) destekalLink.setAttribute('aria-label', `Destekal YKS - ${translations[e].project_3_desc} - ${translations[e].project_3_role}${translations[e].opens_new_tab}`);
